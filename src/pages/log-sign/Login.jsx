...
const Login = () => {
    ...
    return (
        <section className='flex items-center min-h-screen py-10 bg-neutral text-black px-7 xl:px-0'>
            <Container>
                <div className='flex flex-col md:flex-row-reverse text-secondary justify-between shadow-sm p-10 xl:px-52 rounded-xl bg-base-100 relative overflow-hidden'>
